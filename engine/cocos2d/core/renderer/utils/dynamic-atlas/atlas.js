...
cc.js.mixin(Atlas.prototype, {
    insertSpriteFrame (spriteFrame) {
        let rect = spriteFrame._rect,
            ...
            info = this._dynamicTextureRect[texture._uuid];
    ...
    deleteInnerTexture (texture) {
        ...
        this._innerSpriteFrames = this._innerSpriteFrames.filter(frame => !frame._original || frame._original._texture._uuid != texture._uuid);
    },
